...
BORROWED CODE 
CREDIT: 
https://github.com/Aarimous/AudioManager/blob/main/AudioManager.gd
'''
...
func create_audio(type: SoundEffect.SOUND_EFFECT_TYPE, pitch_scale_mod = 0.0) -> void:
	if sound_effect_dict.has(type):
		...
		if sound_effect.has_open_limit():
			...
			new_audio.pitch_scale += pitch_scale_mod
